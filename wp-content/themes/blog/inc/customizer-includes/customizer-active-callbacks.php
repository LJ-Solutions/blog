...
if( ! function_exists( 'blog_is_slider_active' ) ) :
	/**
	* Return true if slider is active
	*
	* @since blog 2.1
	*/
	function blog_is_slider_active( $control ) {
		global $wp_query;
...
if( ! function_exists( 'blog_is_demo_slider_inactive' ) ) :
	/**
	* Return true if demo slider is inactive
	*
	* @since blog 2.1
	*/
	function blog_is_demo_slider_inactive( $control ) {
		global $wp_query;
